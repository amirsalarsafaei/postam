...
class FinderClient(DivarHTTPProxy):
    ...
    _GET_USER_POSTS_ENDPOINT = 'https://api.divar.ir/v1/open-platform/users'
    ...
    def get_user_posts(self, api_key: str, access_token: Optional[str] = None):
